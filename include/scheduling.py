...
def calcular_tiempos(person_seed):
    def hour2min(hours):
        return int(hours * 60)
    ...
    return min2hour(sleep_time), min2hour(work_time), min2hour(total_chores_time), min2hour(total_free_breaks_time)


def calcular_probabilidades(person_seed,
